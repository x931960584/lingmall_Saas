define(['../controllers'], function(controllers) {
    controllers.controller('clientsCategoryCtrl', ['$scope', '$cookieStore', '$state', '$location', '$uibModal','MyClientsSernice', function($scope, $cookieStore, $state, $location, $uibModal,MyClientsSernice) {
        console.log('clientsCategoryCtrl');
        var limit = 100;
        var offset = 0;
        $scope.addShow = false;
        ...
        $scope.blurRank = function(event, name) {
            ...
            if (keycode == 13 && name) {
                ...
                MyClientsSernice.cataAdd(name).then(function(data) {
        ...
        $scope.blurName = function(event, name, id) {
            ...
            if (keycode == 13 && name && id) {
                ...
                MyClientsSernice.cataEdit(id, name).then(function(data) {
                    myClientsList();
                    $scope.defaultShow = function(id) {
                        return true;
                    };
        ...
        $scope.rankDel = function(grade_id) {
                ...
                var modalInstance = $uibModal.open({
                    ...
                    resolve: {
                        ...
                        footer: function() {
                            var option = {
                                submit: MyClientsSernice.cataDel,
                                isList: function() {
                                    myClientsList();
                                }
                            };
        ...
        $scope.rankDefult = function(id) {
            ...
            var modalInstance = $uibModal.open({
                ...
                resolve: {
                    ...
                    footer: function() {
                        var option = {
                            submit: MyClientsSernice.cataDefult,
                            isList: function() {
                                myClientsList();
                            }
                        };
